...
public class CategoryProductData {
    ...
    private static List<Product> teaLatteProducts() {
        ...
        list.add(new Product("Trà Sữa Ô Long Khoai Môn Nghiền", R.mipmap.trasuaolongkhoaimonnghien, 4.9f, "1k", 24000, 28000, 22000, 26000));
    ...
    private static List<Product> milkTeaProducts() {
        ...
        list.add(new Product("Trà Sữa Khoai Môn Nghiền", R.mipmap.trasuakhoaimonnghien, 4.9f, "1k", 22000, 26000, 22000, 26000));
