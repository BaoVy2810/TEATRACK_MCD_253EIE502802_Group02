...
public class AdminPromotionAdapter extends RecyclerView.Adapter<AdminPromotionAdapter.PromotionViewHolder> {
    ...
    public AdminPromotionAdapter(List<Promotion> promotionList, OnPromotionActionListener listener) {
    ...
    public void onBindViewHolder(@NonNull PromotionViewHolder holder, int position) {
        ...
        holder.btnDelete.setOnClickListener(v -> listener.onDelete(promotion));
    }
